...
public class CSVExample {
    ...
    public static void main(String[] args) throws  Exception {
        ...
        recordReader.initialize(new FileSplit(new ClassPathResource("data.txt").getFile()));
        ...
        int batchSize = 100000;    //Iris data set: 150 examples total. We are loading all of them into one DataSet (not recommended for large data sets)
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .list()
            .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(625)
                .build())
            .layer(1, new DenseLayer.Builder().nIn(625).nOut(625)
                .build())
            .layer(2, new OutputLayer.Builder(LossFunctions.LossFunction.NEGATIVELOGLIKELIHOOD)
                .activation(Activation.SOFTMAX)
                .nIn(625).nOut(outputNum).build())
